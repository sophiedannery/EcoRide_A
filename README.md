Ce fichier README a été généré le [2025-07-23] par [Sophie D.].
Dernière mise à jour le : [2025-07-23].
...
Suivez ces étapes pour installer et exécuter le projet EcoRide en local. 
...
Le projet EcoRide a été développé en suivant une stratégie Git inspirée du Gitflow
...
Le nom de domaine *ecoride-app.fr* a été acheté chez [Gandi](https://www.gandi.net/fr) et configuré pour pointer vers **Heroku** via : 
...
Les identifiants de test sont disponibles dans le **manuel d'utilisation** fourni avec le projet. 
